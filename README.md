...
I'm a **Frontend Design Engineer** based in Germany — I bridge the gap between Figma and production-ready React code, with a focus on accessible, token-driven design systems for SaaS products.
...
**Tools** — Git · MODX CMS · Wagtail CMS  
...
📫 Open to remote **Design Engineer** or **Frontend Engineer** roles in product companies  
